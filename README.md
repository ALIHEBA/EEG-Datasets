...
* **Resting State**
  ...
  5. [Lemon-Resting State](http://fcon_1000.projects.nitrc.org/indi/retro/MPI_LEMON/downloads/download_EEG.html) Raw data: 215 subjects, 62 channels (Marker coding = S200 - eyes open rest, S210 - eyes closed rest). Preprocessed data: 204 subjects, 62 channels (condition: eyes closed (EC) or eyes open(EO)). Localizer data: 145 subjects, 62 channels. 
